...
class OfferDetail2 extends StatefulWidget {
  final DocumentSnapshot doc;
  final int c;
  OfferDetail2(this.doc, this.c);
  @override
  _OfferDetail2State createState() => _OfferDetail2State();
}

class _OfferDetail2State extends State<OfferDetail2> {
  int a = 1;
  List<String> images = [];
  var isInit = true;
