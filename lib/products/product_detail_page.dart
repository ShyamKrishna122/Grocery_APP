...
class ProductDetail2 extends StatefulWidget {
  ...
  ProductDetail2(this.doc, this.c);
  @override
  ...
  void didChangeDependencies() {
    if (isInit) {
      try {
        ...
        size = List.from(widget.doc['size']);
        price = List.from(widget.doc['sellingPrice']);
        mprice = List.from(widget.doc['mrp']);
        unit = widget.doc['unit'];
      } catch (e) {}
      setState(() {
        isInit = false;
      });
